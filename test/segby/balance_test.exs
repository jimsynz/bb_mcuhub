defmodule BBMcuhub.Segby.BalanceTest do
  @moduledoc """
  ...
  alias BBMcuhub.Segby.Balance.Pid
  ...
  defp start_controller(extra) do
    ...
    {:ok, pid} = BBMcuhub.Test.ViewHarness.start(Balance, opts)
    pid
  end
  ...
  defp flush(ctrl), do: BBMcuhub.Test.ViewHarness.view_state(ctrl)
end
