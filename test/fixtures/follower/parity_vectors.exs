...
[
  %{
    hub: :imu, port: :pose, type: :imu,
    node: 0x02, port_id: 0xEF,
    seq: 42, t_dev: 1234, stamped: true,
    value: %{ax: 3.5, ay: 4.0, az: 4.5, qw: 1.0, qx: 0.5, qy: 1.0, qz: 1.5, wx: 2.0, wy: 2.5, wz: 3.0},
    body: <<0x2, 0xEF, 0x0, 0x2A, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x4, 0xD2, 0x3F, 0x80, 0x0, 0x0, 0x3F, 0x0, 0x0, 0x0, 0x3F, 0x80, 0x0, 0x0, 0x3F, 0xC0, 0x0, 0x0, 0x40, 0x0, 0x0, 0x0, 0x40, 0x20, 0x0, 0x0, 0x40, 0x40, 0x0, 0x0, 0x40, 0x60, 0x0, 0x0, 0x40, 0x80, 0x0, 0x0, 0x40, 0x90, 0x0, 0x0>>,
    crc: 0xDD45
  },
  %{
    hub: :motor, port: :motor_target, type: :effort,
    node: 0x05, port_id: 0x28,
    seq: 42, t_dev: 1234, stamped: false,
    value: %{nm: 1.0},
    body: <<0x5, 0x28, 0x0, 0x2A, 0x3F, 0x80, 0x0, 0x0>>,
    crc: 0x099C
  },
  %{
    hub: :motor, port: :motor_status, type: :status,
    node: 0x05, port_id: 0xDE,
    seq: 42, t_dev: 1234, stamped: false,
    value: %{applied_seq: 7, floored: false},
    body: <<0x5, 0xDE, 0x0, 0x2A, 0x0, 0x7, 0x0>>,
    crc: 0x6A0C
  }
]
