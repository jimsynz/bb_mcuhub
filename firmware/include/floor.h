 ...
 *
 * Pure logic, no hardware — the firmware binds drive()/safe-action to pins; this
 * is unit-tested on the host. "Advanced?" is a plain inequality (seq != last),
 * sound because every path to this chip is in-order (§04). */
